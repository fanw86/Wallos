...
$i18n = [
    ...
    "guacamole_settings" => "Guacamole settings",
    "enable_guacamole_sso_redirect" => "Enable Guacamole SSO redirect",
    "open_console_in_new_tab" => "Open console in a new tab",
    "guacamole_shared_sso_note" => "Use the same OIDC provider in Wallos and Apache Guacamole, then Wallos can redirect signed-in users straight into Guacamole.",
    "guacamole_template_note" => "Set a launch URL template that matches your Guacamole deployment, for example a direct connection link or a quick connect URL.",
    "guacamole_template_placeholders" => "Available placeholders: {base_url}, {connection_identifier}, {connection_identifier_encoded}, {protocol}, {host}, {port}, {username}, {quickconnect_uri}, and {quickconnect_uri_encoded}.",
    "guacamole_invalid_base_url" => "Enter a valid Guacamole base URL before enabling the integration.",
    "guacamole_invalid_launch_template" => "Enter a Guacamole launch URL template before enabling the integration.",
    "enable_remote_access" => "Enable remote access",
    "remote_protocol" => "Remote protocol",
    "remote_host" => "Remote host",
    "remote_port" => "Remote port",
    "remote_username" => "Remote username",
    "guacamole_connection_identifier" => "Guacamole connection identifier",
    "guacamole_connection_identifier_note" => "Optional. Use this when your launch template points to a pre-provisioned Guacamole connection instead of Quick Connect.",
    "open_console" => "Open console",
    "guacamole_remote_access_not_configured" => "Remote access is not configured for this subscription.",
    "guacamole_launch_not_available" => "Guacamole launch is not available. Check the subscription remote access fields and the admin launch template.",
